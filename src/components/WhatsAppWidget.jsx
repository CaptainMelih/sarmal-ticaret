...
export function WhatsAppWidget() {
    ...
    return (
        <div style={{ position: 'fixed', bottom: '80px', right: '16px', zIndex: 1000, display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            {/* Pop-up Chat Window */}
            {isOpen && (
                <div style={{
                    position: 'absolute',
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontWeight: '800', fontSize: '0.9rem', color: '#15803d' }}>
                    ...
                    <p style={{ fontSize: '0.8rem', color: '#334155', margin: '0 0 1rem 0', lineHeight: '1.45', background: '#f0fdf4', padding: '0.65rem', borderRadius: '10px', border: '1px solid #dcfce7' }}>
